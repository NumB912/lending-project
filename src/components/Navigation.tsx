...
const Navigation = () => {
  ...
  return (
    <div className="navigation content flex justify-between items-center bg-primary border mt-1 border-gray-200 fixed top-0 z-10 p-3 rounded-full">
      ...
      <div className="nav-links flex gap-5 *:p-2 *:hover:text-secondary">
        ...
        <a href="/#contact" className="bg-secondary rounded-r-full flex justify-center items-center gap-2">
